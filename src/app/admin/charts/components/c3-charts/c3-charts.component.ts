...
@Component({
  selector: 'ico-c3-charts',
  templateUrl: './c3-charts.component.html',
  styleUrls: ['./c3-charts.component.scss'],
})
export class C3ChartsComponent {
  ngAfterViewInit() {
    ...
    let charttemperature = c3.generate({
    ...
    var chartareasplinesracked = c3.generate({
    ...
    var chartsplinerotated = c3.generate({
    ...
    var chartbarrotated = c3.generate({
    ...
    var chartbarstacked = c3.generate({
