...
@Component({
  selector: 'ico-bank-salary-generate',
  templateUrl: './bank-salary-generate.component.html',
  styleUrls: ['./bank-salary-generate.component.scss']
})
export class BankSalaryGenerateComponent implements OnInit {
