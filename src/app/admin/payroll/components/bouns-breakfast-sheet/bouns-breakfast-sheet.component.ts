...
@Component({
  selector: 'ico-bouns-breakfast-sheet',
  templateUrl: './bouns-breakfast-sheet.component.html',
  styleUrls: ['./bouns-breakfast-sheet.component.scss']
})
export class BounsBreakfastSheetComponent implements OnInit {
