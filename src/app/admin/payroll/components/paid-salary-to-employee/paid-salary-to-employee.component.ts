...
@Component({
  selector: 'ico-paid-salary-to-employee',
  templateUrl: './paid-salary-to-employee.component.html',
  styleUrls: ['./paid-salary-to-employee.component.scss']
})
export class PaidSalaryToEmployeeComponent implements OnInit {
