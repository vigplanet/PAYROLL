...
@Component({
  selector: 'ico-monthly-salary-generate',
  templateUrl: './monthly-salary-generate.component.html',
  styleUrls: ['./monthly-salary-generate.component.scss']
})
export class MonthlySalaryGenerateComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder) {
    this.Office_Time_Start= moment().format('hh:mm:ss');
   }
