...
@Component({
  selector: 'ico-daily-attendance-master',
  templateUrl: './daily-attendance-master.component.html',
  styleUrls: ['./daily-attendance-master.component.scss']
})
export class DailyAttendanceMasterComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder) {
    this.Office_Time_Start= moment().format('yyyy-MM-DD');
   }
